...
public class PrizeWheel2 {
	...
	// 새 prize를 추가했을 때 총 각도가 360도를 넘으면 안 됨
	public void add(Prize prize) {
		if (prize.getDegree() < 0) {
			System.out.printf("추가하려는 상품 %s의 각도가 음수입니다.\n", prize);
			return;
	...
	// prize를 수정했을 때 총 각도가 360도를 넘으면 안 됨
	public void modifyDegree(int prizeIndex, int degree) {
		...
		if (degree < 0) {
			...
			System.out.printf("[ERROR]\"%s\"의 각도를 %d도에서 %d도로 수정할 수 없습니다.(수정시 360도 초과)\n",
