...
public class E07_File {
	...
	public static void main(String[] args) {
		...
		File ff1 = new File("C:/aiautomation_ljs/java-workspace/JavaStudy/myfiles/emails.txt");
		...
		try {
			FileReader in = new FileReader("myfiles/emails.txt");
