...
public class J03_DBPractice {
	...
	/*
		...
		(3) 해당 계정에 새 테이블을 추가한다.(기본키로 시퀀스를 사용해야 하고, 제약조건을 종류별로 모두 사용해야 한다.)
	...
	public static void insertAnimalKind(String kor, String eng) {
		String sql = "INSERT INTO animal_kind(kind_id, kor_name, eng_name) VALUES(animal_kind_seq.nextval, ?, ?)";
		try (
